...
export const formatPrice = (a: number | null, c = "INR"): string =>
  a === null
    ? "Custom"
...
export const getAnnualMonthlySaving = (p: IPlan): number =>
  !p.monthlyPrice || !p.annualPrice ? 0 : p.monthlyPrice * 12 - p.annualPrice;