...
async function main() {
  ...
  if (count === 0) {
    await prisma.announcement.create({ data: { title: "Welcome to Web4All.in!", body: "Get your website ready in 24 hours starting at ₹300/month.", isPublished: true, publishedAt: new Date() } });
  }
